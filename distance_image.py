...
try:
    while True:
        ...
        depth1 = depth_image[240,320].astype(float)
        distance1 = depth1 * depth_scale
        depth2 = depth_image[240,30].astype(float)
        distance2 = depth2 * depth_scale
        depth3 = depth_image[240,610].astype(float)
        ...
        if distance1 < 1:
         ...
         cv2.imwrite(
        '/home/nvidia/obstacle/center/' + now_time + ".png",
        color_image)
